...
- [**nwb-linkml**](https://nwb-linkml.readthedocs.io/en/latest/)

Gone and made my own translation of NWB schema language to LinkML:

```{mermaid}
flowchart LR
    nwb_schema_language -- adapter --> linkml
    linkml -- generator --> pydantic
    dataset -- loader --> nwb_schema_language
    dataset -- loader --> pydantic
    linkml <-- provider --> cache
    pydantic <-- provider --> cache
```

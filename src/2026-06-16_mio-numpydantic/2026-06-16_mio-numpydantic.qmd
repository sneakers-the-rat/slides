...
## tl;dr it's pretty much done {data-stack-name="Mio/Noob"}
...
## Why the numpydantic detour {data-stack-name="Mio/Noob"}
...
## That's right we rewrote it in rust {data-stack-name="Noob Experiments"}

Before:

![](assets/noob-core-pre.png)

After

![](assets/noob-core-post.png)

## Spiking Neural Net {data-stack-name="Noob Experiments"}
